...
const BusSheduleCard = ({ navigation, time, serviceName, seats, bustype, ticketPrice, duration,identifier }) => {
    return (
            ...
            <View style={styles.cardContent}>
                ...
                <View style={{ flex: 1, alignItems: 'flex-end', gap: 10 }}>
                    ...
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => {
                            // Navigate to 'BookMySheet' with relevant data
                            if (identifier === 'route1') {
                                navigation.navigate('BookMySheet', {
                                    time,
                                    serviceName,
                                    seats,
                                    bustype,
                            ...
                            } else if (identifier === 'route2') {
                                navigation.navigate('BookMySeat2', {
                                    time,
                                    serviceName,
                                    seats,
                                    bustype,
