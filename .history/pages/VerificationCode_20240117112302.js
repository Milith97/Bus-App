...
import { StyleSheet, Text, View, TouchableOpacity, Pressable, ImageBackground, StatusBar } from 'react-native'
...
export default function VerificationCode({ navigation }) {
    ...
    // Function to handle API call for verification
    const handleVerificationApiCall = async () => {
        try {
            const apiUrl = 'https://your-api-endpoint.com/verify-code';
            ...
            if (response.status === 200) {
                // Navigate to the NewPassword screen or perform any other action
        ...
        <SafeAreaView style={styles.root}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.footer}>
                    <View>
                        <Text style={{ color: '#fff' }}>if you did't receive a code! </Text>
                    </View>
                ...
                {/* <TouchableOpacity style={styles.roundButton1} onPress={handleVerificationApiCall}> */}
