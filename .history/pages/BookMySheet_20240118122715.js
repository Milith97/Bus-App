...
import { View, TouchableOpacity, StyleSheet, Dimensions, Alert, StatusBar, Pressable, ScrollView, SafeAreaView, } from 'react-native';
...
const BookMySheet = ({ navigation }) => {
    ...
    const ButtonClick = () => {
        if (selectedSeats.length > 0) {
            ...
            Alert.alert('Select Your Seat(s) First!');
        }
    };
                    ...
                    <View style={styles.btnContainer}>
                        <View style={styles.cardContent}>
                            ...
                            <Card style={{ flex: 1, marginTop: '5%', padding: '8%', borderRadius: 10 }}>
                                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 19, gap: 10 }}>
                                    ...
                                    <View style={{ alignItems: 'center' }}>
                                        ...
                                        <Text style={{}}>UR SEAT</Text>
                                    </View>

                                    <View style={{ alignItems: 'center' }}>
                                        <Text style={styles.box4}></Text>
                                        <Text style={{}}>RESIVED</Text>
                                    </View>
                                </View>
