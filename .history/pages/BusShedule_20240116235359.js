            ...
            <ScrollView>
                <Animatable.View style={styles.midleContent} animation='bounceIn'>
                    <View style={styles.btnContainer}>
                        <BusSheduleCard navigation={navigation} time="9:00 To 11:30 AM" duration="2.5hr" serviceName="Red Bus Express" seats="36 Seats" bustype="Small Bus" ticketPrice="Rs. 1250/-"/>
                        <BusSheduleCard navigation={navigation} serviceName="Naveeen Express" seats="49 Seats" bustype="Big Bus" ticketPrice="Rs. 1250/-"/>
                        <BusSheduleCard navigation={navigation} serviceName="D&S Gunasekara" seats="36 Seats" bustype="Small Bus" />
                        <BusSheduleCard navigation={navigation} serviceName="NTQ Bus Express" seats="49 Seats" bustype="Big Bus" />
                        <BusSheduleCard navigation={navigation} serviceName="Blue Bus Express" seats="49 Seats" bustype="Big Bus" />
                        <BusSheduleCard navigation={navigation} serviceName="Blue Bus Express" seats="36 Seats" bustype="Small Bus" />
                        <BusSheduleCard navigation={navigation} serviceName="Blue Bus Express" seats="49 Seats" bustype="Big Bus" />
                        <BusSheduleCard navigation={navigation} serviceName="Blue Bus Express" seats="36 Seats" bustype="Small Bus" />
                        <BusSheduleCard navigation={navigation} serviceName="Blue Bus Express" seats="49 Seats" bustype="Big Bus" />
                    </View>
