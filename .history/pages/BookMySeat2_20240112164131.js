                ...
                <Animatable.View style={styles.midleContent} animation='bounceIn'>
                    <View style={styles.btnContainer}>
                        ...
                        <Card style={{ flex: 1, marginTop: '5%', padding: '10%', borderRadius: 10 }}>
                            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 15, marginBottom: 19 }}>
                                <View style={{alignItems:'center',}}>
                                    <Text style={styles.box1}></Text>
                                    <Text style={{alignItems:'center'}}>AVAILABLE</Text>
                                </View>
                            ...
                            <View style={styles.seatRow}>
                                ...
                                {[1, 2].map(seatNumber => (
                                    <TouchableOpacity
                                        key={seatNumber}
                                        style={[styles.seat2, selectedSeats.includes(seatNumber) && styles.selectedSeat]}
