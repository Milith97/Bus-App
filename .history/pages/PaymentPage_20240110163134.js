                    ...
                    <View style={styles.btnContainer}>
                        <Card style={{ flex: 1, marginTop: '3%', padding: '3%', borderRadius: 10 }}>
                            ...
                            <View style={styles.cardContent}>
                                <View style={{ height: 100, gap: 5, marginTop: '8%', }}>
                                ...
                                {/* Right Content */}
                                <View style={{ flex: 1, alignItems: 'flex-end', gap: 5, marginTop: '10%', }}>
                            ...
                            <View style={{ flex: 1, justifyContent: 'flex-start', }}>
                                <Text style={{ fontSize: 30, fontWeight: '700', marginTop: '11%', }}>Payment Method</Text>
                            </View>
