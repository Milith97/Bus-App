...
const BusSheduleCard = ({ navigation, time, serviceName, seats, bustype, ticketPrice, duration, bookSheetType }) => {
    return (
            ...
            <View style={styles.cardContent}>
                ...
                <View style={{ flex: 1, alignItems: 'flex-end', gap: 10 }}>
                    ...
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => {
                            const sheetType = props.bookSheetType || 'BookMySheet'; // Default to 'BookMySheet' if prop is not provided
