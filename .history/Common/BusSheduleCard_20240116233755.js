...
const BusSheduleCard = ({ navigation, serviceName }) => {
    return (
        <ScrollView style={styles.scrollViewCard}>
            <View style={styles.cardContent}>
                <View style={{ flex: 1, height: 150, gap: 5 }}>
                    <Text style={{ fontSize: 20, fontWeight: 'bold',color:'#000' }}>9:00 to 11:00</Text>
                    <Text style={{ fontSize: 18, marginTop: 5, color: '#BF4925', fontWeight: '700' }}>{serviceName}0</Text>
